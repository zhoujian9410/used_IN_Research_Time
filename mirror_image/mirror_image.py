...
def main():
	judge=raw_input("Do you want to get all the mirror picture under this file folder?Enter 'y' to continue , others to exit\n\n")
	if judge=="y":
		print "\n\n"
		get_pic()
	else :
		print "\n\n"
		print "wrong input ,this programer will exit right now"
		sleep(3)
		sys.exit()
